        ...
        <Card className="w-96">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Du må være administrator for å administrere leverandører.
            </p>
            <Link to="/">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-primary">Leverandøradministrasjon</h1>
              <p className="text-muted-foreground">Administrer alle leverandører og kontaktinformasjon</p>
            </div>
