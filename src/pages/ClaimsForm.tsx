...
import { ArrowLeft, Upload, Plus, LogOut } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const claimData = {
        ...
        expected_refund: formData.expectedRefund,
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  <Label htmlFor="expectedRefund">Forventet refusjon (kr)</Label>
                  <Input 
                    id="expectedRefund" 
                    type="number"
                    value={formData.expectedRefund}
                    onChange={(e) => handleInputChange('expectedRefund', parseFloat(e.target.value) || 0)}
                    placeholder="0"
                  />
                </div>
              </div>
