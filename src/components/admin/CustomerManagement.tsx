...
import { Search, UserCheck, Building, Mail, Phone, Eye, MapPin } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Oversikt over kunder med reklamasjonshistorikk</p>
        </div>
      </div>
