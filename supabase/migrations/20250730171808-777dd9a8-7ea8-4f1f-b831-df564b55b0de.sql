...
-- Create unique partial indexes instead of WHERE constraints
CREATE UNIQUE INDEX budget_targets_unique_general 
ON public.budget_targets (year) 
WHERE department IS NULL AND supplier_name IS NULL;

CREATE UNIQUE INDEX budget_targets_unique_department 
ON public.budget_targets (year, department) 
WHERE supplier_name IS NULL;

CREATE UNIQUE INDEX budget_targets_unique_supplier 
ON public.budget_targets (year, supplier_name) 
