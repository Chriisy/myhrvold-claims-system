...
-- ENUMS for Norwegian status values
CREATE TYPE IF NOT EXISTS maintenance_status AS ENUM ('planlagt', 'pågår', 'fullført', 'avbrutt');
CREATE TYPE IF NOT EXISTS task_status AS ENUM ('avventer', 'fullført', 'utsatt');
CREATE TYPE IF NOT EXISTS visit_type AS ENUM ('rutine', 'reparasjon', 'installasjon', 'inspeksjon');
